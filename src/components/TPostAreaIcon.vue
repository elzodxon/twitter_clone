<template>
  <button class="t-post-area-icon" @click="$emit('evented')" v-html="icon">
  ...
  props:{
    icon:{
      ...
      default: "<svg width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\">\n" +
        ...
        "<path d=\"M8.86799 9.85103C9.71961 9.85103 10.41 9.16065 10.41 8.30903C10.41 7.45741 9.71961 6.76703 8.86799 6.76703C8.01637 6.76703 7.32599 7.45741 7.32599 8.30903C7.32599 9.16065 8.01637 9.85103 8.86799 9.85103Z\" fill=\"#1DA1F2\"/>\n" +
        "</svg>\n"
    }
  }
}
